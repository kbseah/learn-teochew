...
Classifiers are used together with demonstratives (see [“Demonstrative pronouns”]({{ site.baseurl }}{% link pages/demonstrative_pronouns.md %})) when referring to specific objects (“this”, “that”, “each”, “every”).
...
Classifiers are used in questions (see [“Questions”]({{ site.baseurl }}{% link pages/questions.md %})) when asking about specific objects (“which”, “how many”).
...
See also the section “Possessive pronouns” under [“Personal pronouns”]({{ site.baseurl }}{% link pages/personal_pronouns.md %}).
